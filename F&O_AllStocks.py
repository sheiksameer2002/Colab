...
# ============================================================
# COMBINED SCRIPT (UPDATED v4 — ALL ACCEPTED STOCKS, ZONE-FIRST SCORING)
#   PART 1 — CONDITION SCREENER
#   PART 2 — OI SENTIMENT CLASSIFIER (runs inline, per stock)
#   FINAL   — Prints OI summary table (ALL accepted, sorted by ATM CE Δ),
#             saves ALL accepted stocks (minus negative-leg exclusion)
#             to matched_stocks.txt, saves OI_data.json + CSV
# ============================================================
...
# ------------------------------
# STOCK LIST (TRIMMED TO 20 FOR TESTING — update this later)
# ------------------------------

STOCKS =['NSE:360ONE-EQ', 'NSE:ABB-EQ', 'NSE:ABCAPITAL-EQ', 'NSE:ADANIENSOL-EQ', 'NSE:ADANIENT-EQ', 'NSE:ADANIGREEN-EQ', 'NSE:ADANIPORTS-EQ', 'NSE:ADANIPOWER-EQ', 'NSE:ALKEM-EQ', 'NSE:AMBER-EQ', 'NSE:AMBUJACEM-EQ', 'NSE:ANGELONE-EQ', 'NSE:APLAPOLLO-EQ', 'NSE:APOLLOHOSP-EQ', 'NSE:ASHOKLEY-EQ', 'NSE:ASIANPAINT-EQ', 'NSE:ASTRAL-EQ', 'NSE:ATHERENERG-EQ', 'NSE:AUBANK-EQ', 'NSE:AUROPHARMA-EQ', 'NSE:AXISBANK-EQ', 'NSE:BAJAJ-AUTO-EQ', 'NSE:BAJAJFINSV-EQ', 'NSE:BAJAJHLDNG-EQ', 'NSE:BAJFINANCE-EQ', 'NSE:BANDHANBNK-EQ', 'NSE:BANKBARODA-EQ', 'NSE:BANKINDIA-EQ', 'NSE:BDL-EQ', 'NSE:BEL-EQ', 'NSE:BHARATFORG-EQ', 'NSE:BHARTIARTL-EQ', 'NSE:BHEL-EQ', 'NSE:BIOCON-EQ', 'NSE:BLUESTARCO-EQ', 'NSE:BOSCHLTD-EQ', 'NSE:BPCL-EQ', 'NSE:BRITANNIA-EQ', 'NSE:BSE-EQ', 'NSE:CAMS-EQ', 'NSE:CANBK-EQ', 'NSE:CDSL-EQ', 'NSE:CGPOWER-EQ', 'NSE:CHOLAFIN-EQ', 'NSE:CIPLA-EQ', 'NSE:COALINDIA-EQ', 'NSE:COCHINSHIP-EQ', 'NSE:COFORGE-EQ', 'NSE:COLPAL-EQ', 'NSE:CONCOR-EQ', 'NSE:CROMPTON-EQ', 'NSE:CUMMINSIND-EQ', 'NSE:DABUR-EQ', 'NSE:DELHIVERY-EQ', 'NSE:DIVISLAB-EQ', 'NSE:DIXON-EQ', 'NSE:DLF-EQ', 'NSE:DMART-EQ', 'NSE:DRREDDY-EQ', 'NSE:EICHERMOT-EQ', 'NSE:ETERNAL-EQ', 'NSE:FEDERALBNK-EQ', 'NSE:FORCEMOT-EQ', 'NSE:FORTIS-EQ', 'NSE:GAIL-EQ', 'NSE:GLENMARK-EQ', 'NSE:GMRAIRPORT-EQ', 'NSE:GODFRYPHLP-EQ', 'NSE:GODREJCP-EQ', 'NSE:GODREJPROP-EQ', 'NSE:GRASIM-EQ', 'NSE:GVT&D-EQ', 'NSE:HAL-EQ', 'NSE:HAVELLS-EQ', 'NSE:HCLTECH-EQ', 'NSE:HDFCAMC-EQ', 'NSE:HDFCBANK-EQ', 'NSE:HDFCLIFE-EQ', 'NSE:HEROMOTOCO-EQ', 'NSE:HINDALCO-EQ', 'NSE:HINDPETRO-EQ', 'NSE:HINDUNILVR-EQ', 'NSE:HINDZINC-EQ', 'NSE:HYUNDAI-EQ', 'NSE:ICICIBANK-EQ', 'NSE:ICICIGI-EQ', 'NSE:ICICIPRULI-EQ', 'NSE:IDEA-EQ', 'NSE:IDFCFIRSTB-EQ', 'NSE:IEX-EQ', 'NSE:INDHOTEL-EQ', 'NSE:INDIANB-EQ', 'NSE:INDIGO-EQ', 'NSE:INDUSINDBK-EQ', 'NSE:INDUSTOWER-EQ', 'NSE:INFY-EQ', 'NSE:INOXWIND-EQ', 'NSE:IOC-EQ', 'NSE:IREDA-EQ', 'NSE:IRFC-EQ', 'NSE:ITC-EQ', 'NSE:JINDALSTEL-EQ', 'NSE:JIOFIN-EQ', 'NSE:JSWENERGY-EQ', 'NSE:JSWSTEEL-EQ', 'NSE:JUBLFOOD-EQ', 'NSE:KALYANKJIL-EQ', 'NSE:KAYNES-EQ', 'NSE:KEI-EQ', 'NSE:KFINTECH-EQ', 'NSE:KOTAKBANK-EQ', 'NSE:KPITTECH-EQ', 'NSE:LAURUSLABS-EQ', 'NSE:LICHSGFIN-EQ', 'NSE:LICI-EQ', 'NSE:LODHA-EQ', 'NSE:LT-EQ', 'NSE:LTF-EQ', 'NSE:LTM-EQ', 'NSE:LUPIN-EQ', 'NSE:M&M-EQ', 'NSE:MAHABANK-EQ', 'NSE:MANAPPURAM-EQ', 'NSE:MANKIND-EQ', 'NSE:MARICO-EQ', 'NSE:MARUTI-EQ', 'NSE:MAXHEALTH-EQ', 'NSE:MAZDOCK-EQ', 'NSE:MCX-EQ', 'NSE:MFSL-EQ', 'NSE:MOTHERSON-EQ', 'NSE:MOTILALOFS-EQ', 'NSE:MPHASIS-EQ', 'NSE:MUTHOOTFIN-EQ', 'NSE:NAM-INDIA-EQ', 'NSE:NATIONALUM-EQ', 'NSE:NAUKRI-EQ', 'NSE:NBCC-EQ', 'NSE:NESTLEIND-EQ', 'NSE:NHPC-EQ', 'NSE:NMDC-EQ', 'NSE:NTPC-EQ', 'NSE:NYKAA-EQ', 'NSE:OBEROIRLTY-EQ', 'NSE:OFSS-EQ', 'NSE:OIL-EQ', 'NSE:ONGC-EQ', 'NSE:PAGEIND-EQ', 'NSE:PATANJALI-EQ', 'NSE:PAYTM-EQ', 'NSE:PERSISTENT-EQ', 'NSE:PETRONET-EQ', 'NSE:PFC-EQ', 'NSE:PGEL-EQ', 'NSE:PHOENIXLTD-EQ', 'NSE:PIDILITIND-EQ', 'NSE:PIIND-EQ', 'NSE:PNB-EQ', 'NSE:PNBHOUSING-EQ', 'NSE:POLICYBZR-EQ', 'NSE:POLYCAB-EQ', 'NSE:POWERGRID-EQ', 'NSE:POWERINDIA-EQ', 'NSE:PREMIERENE-EQ', 'NSE:PRESTIGE-EQ', 'NSE:RADICO-EQ', 'NSE:RBLBANK-EQ', 'NSE:RECLTD-EQ', 'NSE:RELIANCE-EQ', 'NSE:RVNL-EQ', 'NSE:SAGILITY-EQ', 'NSE:SAIL-EQ', 'NSE:SBICARD-EQ', 'NSE:SBILIFE-EQ', 'NSE:SBIN-EQ', 'NSE:SHREECEM-EQ', 'NSE:SHRIRAMFIN-EQ', 'NSE:SIEMENS-EQ', 'NSE:SOLARINDS-EQ', 'NSE:SONACOMS-EQ', 'NSE:SRF-EQ', 'NSE:SUNPHARMA-EQ', 'NSE:SUPREMEIND-EQ', 'NSE:SUZLON-EQ', 'NSE:SWIGGY-EQ', 'NSE:TATACONSUM-EQ', 'NSE:TATAELXSI-EQ', 'NSE:TATAPOWER-EQ', 'NSE:TATASTEEL-EQ', 'NSE:TCS-EQ', 'NSE:TECHM-EQ', 'NSE:TIINDIA-EQ', 'NSE:TITAN-EQ', 'NSE:TMPV-EQ', 'NSE:TORNTPHARM-EQ', 'NSE:TRENT-EQ', 'NSE:TVSMOTOR-EQ', 'NSE:ULTRACEMCO-EQ', 'NSE:UNIONBANK-EQ', 'NSE:UNITDSPR-EQ', 'NSE:UNOMINDA-EQ', 'NSE:UPL-EQ', 'NSE:VBL-EQ', 'NSE:VEDL-EQ', 'NSE:VMM-EQ', 'NSE:VOLTAS-EQ', 'NSE:WAAREEENER-EQ', 'NSE:WIPRO-EQ', 'NSE:YESBANK-EQ', 'NSE:ZYDUSLIFE-EQ']
...
#   exclude that stock — zero is treated as a non-negative (i.e.
#   "positive") value here, not negative.
# ─────────────────────────────────────────────
...
try:
    ...
    # ============================================================
    # v4 CHANGE: save ALL accepted stocks that produced OI data,
    #   NOT just the ones where ATM PE Δ == Full-chain PE Δ.
    #   The negative-leg exclusion (all four legs negative) is still
    #   applied — that's a separate "junk data" filter, unrelated to
    #   the PE-delta equality condition that used to gate this list.
    # ============================================================
    all_accepted_list = [
        f"NSE:{r['symbol']}-EQ"
        for r in oi_results
        if not all_legs_negative(r)
    ]

    try:

        with open(output_file, "w") as f:
            f.write(f"STOCKS={all_accepted_list}")

        print(f"\n✅ ALL accepted stocks (excluding all-legs-negative) saved to:")
        print(date_to_check)
        print(output_file)
        print(all_accepted_list)
    ...
    # v4 CHANGE: console table now ALWAYS shows every accepted stock
    # that produced OI data (already sorted ascending by ATM CE Δ
    # above) — no more filtering down to only the PE-delta-equal set.
